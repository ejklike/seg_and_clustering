...
class TICC:
    ...
    def fit(self, input_data):
        ...
        times_series_arr = input_data
        time_series_rows_size, time_series_col_size = input_data.shape
        ...
        try:
            for iters in range(self.maxIters):
                ...
                self.write_plot(clustered_points, str_NULL, training_indices, iters)
            ...
            clustered_points, train_cluster_inverse, bic = None, None, -1
    ...
    def write_plot(self, clustered_points, str_NULL, training_indices, iters):
    ...
    def prepare_out_directory(self):
        str_NULL = (
            self.prefix_string + 
            "ld=" + str(self.lambda_parameter) + 
            "bt=" + str(self.switch_penalty) +
            "ws=" + str(self.window_size) + 
            "nC=" + str(self.number_of_clusters) + 
            "/")
    ...
    def load_data(self, input_file):
        Data = np.loadtxt(input_file, delimiter="\t", encoding='UTF-8')
